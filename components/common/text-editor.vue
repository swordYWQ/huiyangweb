<template>
  <section class="editor-container">
    ...
    <div class="text-editor-loading" v-if="!isReady">
      <i class="iconfont icon-loading"></i>
    </div>
    <div id="toolbar" v-show="isReady">
    ...
    <div class="quill-editor" ref="myTextEditor"
       v-model="content" @ready="onEditorReady($event)" @change="onEditorChange($event)"
       v-quill:myQuillEditor="editorOption">
    </div>
  </section>
</template>
...
.editor-container {
  ...
  .text-editor-loading {
    ...
    .icon-loading {
      ...
      animation: loading-animate 3s infinite ease-in;
    }
  }
}
